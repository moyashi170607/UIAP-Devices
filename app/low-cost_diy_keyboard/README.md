...
- バージョン20251205です。
- キーボード材料費: 700円未満、工具費: 1,664円(イニシャル)です。
- 汎用品・市販品(日本国内販売品)のみで製作します。
- 製作所要時間は90~120minです。

# Tools / 工具

**合計1,664円**です。なくても製作できますが、こて先クリーナーとピンセットはあったほうが作業性がよいです。
...
| WANT [こて先クリーナー ST-30: 工具・工作用品 秋月電子通商-電子部品・ネット通販](https://akizukidenshi.com/catalog/g/g102538/) | 264 | 1 | 264 |
...
| [チタンコーティング鉄工ドリル刃６角ビット付 - 100均 通販 ダイソーネットストア【公式】](https://jp.daisonet.com/products/4984343920316) *3.0mm | 100 | 1 | 100 |
| [チタンコーティング鉄工ドリル刃６角ビット付 - 100均 通販 ダイソーネットストア【公式】](https://jp.daisonet.com/products/4984343920378) *4.0mm | 100 | 1 | 100 |
| [チタンコーティング鉄工ドリル刃６角ビット付 - 100均 通販 ダイソーネットストア【公式】](https://jp.daisonet.com/products/4984343920392) *5.0mm | 100 | 1 | 100 |
